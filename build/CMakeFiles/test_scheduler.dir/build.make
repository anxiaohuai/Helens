...
CMakeFiles/test_scheduler.dir/tests/test_scheduler.cc.o: ../tests/test_scheduler.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/hg/helens/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/test_scheduler.dir/tests/test_scheduler.cc.o"
	/apps/sylar/bin/g++  $(CXX_DEFINES) -D__FILE__=\"tests/test_scheduler.cc\" $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/test_scheduler.dir/tests/test_scheduler.cc.o -c /home/hg/helens/tests/test_scheduler.cc
...
CMakeFiles/test_scheduler.dir/tests/test_scheduler.cc.i: cmake_force
	...
	/apps/sylar/bin/g++ $(CXX_DEFINES) -D__FILE__=\"tests/test_scheduler.cc\" $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/hg/helens/tests/test_scheduler.cc > CMakeFiles/test_scheduler.dir/tests/test_scheduler.cc.i
...
CMakeFiles/test_scheduler.dir/tests/test_scheduler.cc.s: cmake_force
	...
	/apps/sylar/bin/g++ $(CXX_DEFINES) -D__FILE__=\"tests/test_scheduler.cc\" $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/hg/helens/tests/test_scheduler.cc -o CMakeFiles/test_scheduler.dir/tests/test_scheduler.cc.s
...
../bin/test_scheduler: ../lib/libhelens.so
../bin/test_scheduler: /usr/lib64/libz.so
../bin/test_scheduler: /usr/lib64/libssl.so
../bin/test_scheduler: /usr/lib64/libcrypto.so
../bin/test_scheduler: /apps/sylar/lib/libprotobuf.so
../bin/test_scheduler: CMakeFiles/test_scheduler.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/hg/helens/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../bin/test_scheduler"
...
CMakeFiles/test_scheduler.dir/depend:
	cd /home/hg/helens/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/hg/helens /home/hg/helens /home/hg/helens/build /home/hg/helens/build /home/hg/helens/build/CMakeFiles/test_scheduler.dir/DependInfo.cmake --color=$(COLOR)

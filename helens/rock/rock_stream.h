#ifndef __HELENS_ROCK_ROCK_STREAM_H__
#define __HELENS_ROCK_ROCK_STREAM_H__

#include "helens/streams/async_socket_stream.h"
#include "rock_protocol.h"
#include "helens/streams/load_balance.h"
...
class RockStream : public helens::AsyncSocketStream {
public:
    typedef std::shared_ptr<RockStream> ptr;
    typedef std::function<bool(helens::RockRequest::ptr
                               ,helens::RockResponse::ptr
                               ,helens::RockStream::ptr)> request_handler;
    typedef std::function<bool(helens::RockNotify::ptr
                               ,helens::RockStream::ptr)> notify_handler;
...
protected:
    ...
    void handleRequest(helens::RockRequest::ptr req);
    void handleNotify(helens::RockNotify::ptr nty);
private:
...
public:
    ...
    RockConnection();
    bool connect(helens::Address::ptr addr);
};

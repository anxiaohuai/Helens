 ...
 */
#ifndef __HELENS_SOCKET_H__
#define __HELENS_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(helens::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(helens::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(helens::Address::ptr address);

 ...
 */
#ifndef __HELENS_TCP_SERVER_H__
#define __HELENS_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(helens::IOManager* worker = helens::IOManager::GetThis()
              ,helens::IOManager* io_woker = helens::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(helens::Address::ptr addr, bool ssl = false);

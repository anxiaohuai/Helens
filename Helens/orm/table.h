#ifndef __HELENS_ORM_TABLE_H__
#define __HELENS_ORM_TABLE_H__
...
private:
    ...
    std::string m_dbclass = "helens::IDB";
    std::string m_queryclass = "helens::IDB";
    std::string m_updateclass = "helens::IDB";

 ...
 */
#ifndef __HELENS_HTTP_SERVLET_H__
#define __HELENS_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(helens::http::HttpRequest::ptr request
                   ...
                   , helens::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (helens::http::HttpRequest::ptr request
                   , helens::http::HttpResponse::ptr response
                   , helens::http::HttpSession::ptr session)> callback;

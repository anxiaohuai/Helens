...
int32_t FunctionWSServlet::onConnect(helens::http::HttpRequest::ptr header
...
int32_t FunctionWSServlet::onClose(helens::http::HttpRequest::ptr header
                                     ,helens::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(helens::http::HttpRequest::ptr header

...
int32_t FunctionServlet::handle(helens::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("helens/1.0"));
}

int32_t ServletDispatch::handle(helens::http::HttpRequest::ptr request
               , helens::http::HttpResponse::ptr response
               , helens::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(helens::http::HttpRequest::ptr request
                   , helens::http::HttpResponse::ptr response
                   , helens::http::HttpSession::ptr session) {
    response->setStatus(helens::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "helens/1.0.0");

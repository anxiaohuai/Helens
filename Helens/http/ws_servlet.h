...
public:
    ...
    virtual int32_t onConnect(helens::http::HttpRequest::ptr header
                              ,helens::http::WSSession::ptr session) = 0;
...
public:
    ...
    typedef std::function<int32_t (helens::http::HttpRequest::ptr header
                              ,helens::http::WSSession::ptr session)> on_connect_cb;
    typedef std::function<int32_t (helens::http::HttpRequest::ptr header
                             ,helens::http::WSSession::ptr session)> on_close_cb; 
    typedef std::function<int32_t (helens::http::HttpRequest::ptr header
                           ,helens::http::WSFrameMessage::ptr msg
                           ,helens::http::WSSession::ptr session)> callback;

#ifndef __HELENS_HTTP_WS_SESSION_H__
#define __HELENS_HTTP_WS_SESSION_H__

#include "helens/config.h"
#include "helens/http/http_session.h"
#include <stdint.h>
...
extern helens::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;

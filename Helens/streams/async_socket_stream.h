#ifndef __HELENS_STREAMS_ASYNC_SOCKET_STREAM_H__
#define __HELENS_STREAMS_ASYNC_SOCKET_STREAM_H__
...
public:
    void setWorker(helens::IOManager* v) { m_worker = v;}
    helens::IOManager* getWorker() const { return m_worker;}

    void setIOManager(helens::IOManager* v) { m_iomanager = v;}
    helens::IOManager* getIOManager() const { return m_iomanager;}
...
protected:
    ...
    bool waitFiber();
protected:
    helens::FiberSemaphore m_sem;
    helens::FiberSemaphore m_waitSem;
    ...
    helens::IOManager* m_iomanager;
    helens::IOManager* m_worker;

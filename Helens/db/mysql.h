#ifndef __HELENS_DB_MYSQL_H__
#define __HELENS_DB_MYSQL_H__
...
public:
    ...
    helens::IStmt::ptr prepare(const std::string& sql) override;
...
class MySQLManager {
public:
    typedef helens::Mutex MutexType;
...
typedef helens::Singleton<MySQLManager> MySQLMgr;

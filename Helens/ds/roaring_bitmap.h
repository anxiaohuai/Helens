#ifndef __HELENS_DS_ROARING_BITMAP_H__
#define __HELENS_DS_ROARING_BITMAP_H__
...
public:
    ...
    void writeTo(helens::ByteArray::ptr ba) const;
    bool readFrom(helens::ByteArray::ptr ba);

#ifndef __HELENS_DS_HASH_MAP2_H__
#define __HELENS_DS_HASH_MAP2_H__
...
public:
    ...
    void swap(HashMap& oth) {
        helens::RWMutex::WriteLock lock(m_mutex);
        helens::RWMutex::WriteLock lock2(oth.m_mutex);
...
template<class K
        ...
        ,class PosHash
        >
helens::RWMutex HashMap<K, V, PosHash>::s_mutex[MAX_MUTEX];
